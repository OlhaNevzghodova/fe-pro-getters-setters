...
export const school = {
    ...
    get aGradeStudents() {
        return Object.values(this.students)
            .filter((element) => element.averageGrade >= 90 && element.averageGrade <= 100)
            .map((element) => element.name)
            .join(', ');
    },
    get bGradeStudents() {
        return Object.values(this.students)
            .filter((element) => element.averageGrade >= 75 && element.averageGrade <= 89)
            .map((element) => element.name)
            .join(', ');
    },
    get cGradeStudents() {
        return Object.values(this.students)
            .filter((element) => element.averageGrade >= 60 && element.averageGrade < 75)
            .map((element) => element.name)
            .join(', ');
    },
    get dGradeStudents() {
        return Object.values(this.students)
            .filter((element) => element.averageGrade >= 0 && element.averageGrade <= 59)
            .map((element) => element.name)
            .join(', ');
    },
